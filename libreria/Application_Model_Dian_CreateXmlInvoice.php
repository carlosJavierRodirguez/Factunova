...
class Application_Model_Dian_CreateXmlInvoice
{
   ...
   public function prepareUBLExtensions($data)
   {
      ...
      <ext:UBLExtension>
         <ext:ExtensionContent>
            <sts:DianExtensions>
               <sts:InvoiceControl>
                  <sts:InvoiceAuthorization>{$data['InvoiceAuthorization']}</sts:InvoiceAuthorization>
   ...
   public function prepareVersionXml($CustomizationID, $ProfileExecutionID, $ID, $UUID, $IssueDate, $IssueTime, $InvoiceTypeCode, $LineCountNumeric, $InvoicePeriodStartDate, $InvoicePeriodEndDate)
   {
      return " 
   ...
   public function prepareAccountingSupplierParty($AdditionalAccountID, $IndustryClassificationCode, $NombreEmpresa, $CodigoPostal, $CityName, $CountrySubentity, $CountrySubentityCode, $Line, $RegistrationName, $NitEmpresa, $TaxLevelCode, $CodigoCiudad)
   {
      ...
      return "    
       ...
       <cac:Party>
           ...
           <cac:PartyTaxScheme>
               ...
               <cbc:CompanyID schemeAgencyID='195' schemeAgencyName='CO, DIAN (Dirección de Impuestos y Aduanas Nacionales)' schemeID='4' schemeName='31'>$NitEmpresa</cbc:CompanyID>
                ...
                <cac:Party>
                    ...
                    <cac:PhysicalLocation>
                        <cac:Address>
                           ...
                           <cbc:ID>$CodigoCiudadCliente</cbc:ID>
                           <cbc:CityName>$NombreCiudadCliente </cbc:CityName>
                           <cbc:CountrySubentity>$NombreDepartamentoCliente</cbc:CountrySubentity>
                           <cbc:CountrySubentityCode>$CodigoDepartamentoCliente</cbc:CountrySubentityCode>

                           <cac:AddressLine>
                              <cbc:Line>$AddressCliente</cbc:Line>
                           </cac:AddressLine>
                    ...
                    <cac:PartyTaxScheme>
                        ...
                        <cbc:CompanyID schemeAgencyID='195' schemeAgencyName='CO, DIAN (Dirección de Impuestos y Aduanas Nacionales)' schemeID='3' schemeName='31'>$NitCliente</cbc:CompanyID>
