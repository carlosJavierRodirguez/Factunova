...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="UBL-model">
  ...
  <rule flag="fatal" role="fatal" context="sts:ProviderID">
    ...
    <assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HD04b]-DV del NIT del Proveedor Tecnologico : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
...
<rule flag="fatal" role="fatal" context="sts:AuthorizationProviderID">
  ...
  <let name="k" value="$j mod 11"/>
  <let name="dv" value="if ($k &gt;= 2) then 11 - $k else $k"/>
  <assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HD04b]-DV del NIT del Proveedor Autorizado : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
...
<assert flag="fatal" test=". = 'UBL 2.1'">[AA05]- (R) UBLVersionID : '<value-of select="."/>
' no contiene el literal “UBL 2.1”</assert>
</rule>
<rule flag="fatal" role="fatal" context="cbc:ProfileID">
<assert flag="fatal" test=". = 'DIAN 2.0'">[AA07]- (R) ProfileID : '<value-of select="."/>
' no contiene el literal “DIAN 2.0”</assert>
</rule>
<!-- Validaciones sobre el Prefijo del documento  -->
<rule flag="warning" role="warning" context="sts:Prefix">
<assert flag="warning" test=". = //cac:AccountingSupplierParty//cac:CorporateRegistrationScheme/cbc:ID">[DA10]- (R) '<value-of select="."/>
' Debe ser igual al código de la sucursal correspondiente a este punto de facturación '<value-of select="//cac:AccountingSupplierParty//cac:CorporateRegistrationScheme/cbc:ID"/>
'</assert>
</rule>
<!-- Validaciones sobre el numero del documento  -->
<rule flag="fatal" role="fatal" context="/descendant::cbc:ID[1]">
<assert flag="fatal" test="not(matches(., '\s')) and not(contains(., '-'))">[AA08a]- (R) Número de factura : '<value-of select="."/>
' contiene caracteres adicionales como espacios o guiones</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then number(substring-after(., //sts:Prefix)) &gt; number(//sts:From) else true()">[AA08b]- (R) Número de factura : '<value-of select="."/>
' inferior al inicio del rango de numeración otorgado: '<value-of select="//sts:From"/>
'</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then number(substring-after(., //sts:Prefix)) &lt; number(//sts:To) else true()">[AA08c]- (R) Número de factura : '<value-of select="."/>
' superior al final del rango de numeración otorgado: '<value-of select="//sts:To"/>
'</assert>
</rule>
<!-- Validaciones sobre la fecha de emision del documento -->
<rule flag="fatal" role="fatal" context="/descendant::cbc:IssueDate[1]">
<assert flag="fatal" test="xs:dateTime(concat(., 'T', /descendant::cbc:IssueTime[1])) &lt; current-dateTime() + xs:dayTimeDuration('P10DT0H')">[AA12b]- (R) Fecha de emision : '<value-of select="concat(., 'T', /descendant::cbc:IssueTime[1])"/>
' es posterior a diez días calendario contados desde la fecha de transmisión del archivo para su validacón : '<value-of select="current-dateTime()"/>
'</assert>
<assert flag="fatal" test="xs:dateTime(concat(., 'T', /descendant::cbc:IssueTime[1])) &gt; current-dateTime() - xs:dayTimeDuration('P5DT0H')">[AA12c]- (R) Fecha de emision : '<value-of select="concat(., 'T', /descendant::cbc:IssueTime[1])"/>
' es anterior a cinco días calendario restados de la fecha actual : '<value-of select="current-dateTime()"/>
'</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then xs:date(.) &gt;= xs:date(//sts:InvoiceControl/sts:AuthorizationPeriod/cbc:StartDate) else true()">[DA07]- (R) Fecha de emisión : '<value-of select="."/>
' anterior al la fecha de inicio de la autorización de la numeración : '<value-of select="//sts:InvoiceControl/sts:AuthorizationPeriod/cbc:StartDate"/>
'</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then xs:date(.) &lt;= xs:date(//sts:InvoiceControl/sts:AuthorizationPeriod/cbc:EndDate) else true()">[DA08]- (R) Fecha de emisión :'<value-of select="."/>
' posterior al la fecha final de la autorización de la numeración : '<value-of select="//sts:InvoiceControl/sts:AuthorizationPeriod/cbc:EndDate"/>
'</assert>
</rule>
...
<assert flag="fatal" test="string-length(.)=14 and substring(.,3,1)=':' and substring(.,6,1)=':' and substring(.,9,6)='-05:00'">[AA13a]- (R) Hora del envio : '<value-of select="."/>
' no esta en el formato autorizado HH:MM:SS-05-00</assert>
<assert flag="fatal" test="$hour>=0 and $hour&lt;=23">[AA13b]- (R) Hora del envio : '<value-of select="$hour"/>
' debe ser entre 0 y 23</assert>
<assert flag="fatal" test="$minute>=0 and $minute&lt;=59">[AA13c]- (R) Minuto del envio : '<value-of select="$minute"/>
' debe ser entre 0 y 59</assert>
<assert flag="fatal" test="$second>=0 and $second&lt;=59">[AA13d]- (R) Minuto del envio : '<value-of select="$second"/>
' debe ser entre 0 y 59</assert>
<assert flag="fatal" test="$timezone = '-05:00'">[AA13e]- (R) Zona horaria del envio : '<value-of select="$timezone"/>
' debe ser de Colombia (-05:00)</assert>
</rule>
<!-- Validaciones cantidad lineas de detalle -->
<rule flag="fatal" role="fatal" context="cbc:LineCountNumeric">
<assert flag="fatal" test=". = count(//cac:InvoiceLine) or . = count(//cac:CreditNoteLine) or . = count(//cac:DebitNoteLine)">[AA18]- (R) LineCountNumeric : '<value-of select="."/>
' diferente del número de ocurrencias del grupo /Invoice/cac:InvoiceLine : '<value-of select="count(//cac:InvoiceLine)"/>
'</assert>
</rule>
...
<let name="k" value="$j mod 11"/>
<let name="dv" value="if ($k &gt;= 2) then 11 - $k else $k"/>
<assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HC04]- (R) DV del NIT del emisor : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
...
<let name="k" value="$j mod 11"/>
<let name="dv" value="if ($k &gt;= 2) then 11 - $k else $k"/>
<assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HD04b]-DV del NIT del adquiriente : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
...
<let name="k" value="$j mod 11"/>
<let name="dv" value="if ($k &gt;= 2) then 11 - $k else $k"/>
<assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HD04b]-DV del NIT del transportista : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
...
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02') then (round(../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount) = round(sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount))) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount)"/>
' </assert>
...
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:TaxAmount)"/>
' </assert>
...
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '21') then (round(../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '21']/cbc:TaxAmount) = round(sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '21']/cbc:TaxAmount))) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '21']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '21']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22') then (round(../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount) = round(sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount))) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '23') then (round(../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '23']/cbc:TaxAmount) = round(sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '23']/cbc:TaxAmount))) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '23']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '23']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '24') then (round(../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '24']/cbc:TaxAmount) = round(sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '24']/cbc:TaxAmount))) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '24']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '24']/cbc:TaxAmount)"/>
' </assert>
...
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '01') then (../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:TaxAmount = ((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible: <value-of select="((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '01']/cbc:Percent) div 100)"/>
</assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02') then (../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount = ((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible: <value-of select="((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '02']/cbc:Percent) div 100)"/>
</assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '03') then (../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:TaxAmount = ((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible: <value-of select="((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '03']/cbc:Percent) div 100)"/>
</assert>
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '04') then (../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:TaxAmount = ((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible: <value-of select="((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:TaxableAmount * ../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '04']/cbc:Percent) div 100)"/>
</assert>
...
<assert flag="fatal" test="if (../cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22') then (../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount = ((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:PerUnitAmount * $InvoicedQtyImpBolsa))) else true()">[HB07]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:TaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:TaxAmount"/>
 es diferente del producto de la cantidad de items vendidos aplicado sobre el impuesto unico por unidad: <value-of select="((../cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '22']/cbc:PerUnitAmount * $InvoicedQtyImpBolsa))"/>
</assert>
...
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05') then (../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cbc:TaxAmount = sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cbc:TaxAmount)) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06') then (../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cbc:TaxAmount = sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cbc:TaxAmount)) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cbc:TaxAmount)"/>
' </assert>
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07') then (../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cbc:TaxAmount = sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cbc:TaxAmount)) else true()">[HB02]- (R) Valor total de un tributo : '<value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cbc:TaxAmount"/>
' no corresponde a la suma de todas las informaciones correspondentes a cada una de las tarifas informadas en este documento para este tributo: '<value-of select="sum(../cac:WithholdingTaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cbc:TaxAmount)"/>
' </assert>
...
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05') then (every $i in ../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cac:TaxSubtotal satisfies $i/cbc:TaxAmount = (($i/cbc:TaxableAmount * $i/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '05']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible</assert>
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06') then (every $i in ../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cac:TaxSubtotal satisfies $i/cbc:TaxAmount = (($i/cbc:TaxableAmount * $i/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '06']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible</assert>
<assert flag="fatal" test="if (../cac:WithholdingTaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07') then (every $i in ../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cac:TaxSubtotal satisfies $i/cbc:TaxAmount = (($i/cbc:TaxableAmount * $i/cac:TaxCategory/cbc:Percent) div 100)) else true()">[HB06]- (R) El valor del tributo correspondiente a una de las tarifas <value-of select="../cac:WithholdingTaxTotal[cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID = '07']/cbc:TaxAmount"/>
 es diferente del producto del porcentaje aplicado sobre la base imponible</assert>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then . = (sum(../../cac:InvoiceLine/cbc:LineExtensionAmount)) else true()">[IB02]- (R) Valor bruto total de la factura antes de tributos <value-of select="."/>
 diferente de la suma de los valores de las líneas de la factura que contienen valor comercial: <value-of select="(sum(../..//cac:InvoiceLine/cbc:LineExtensionAmount))"/>
</assert>
<assert flag="fatal" test="if (boolean(/CreditNote)) then . = (sum(../../cac:CreditNoteLine/cbc:LineExtensionAmount)) else true()">[IB02]- (R) Valor bruto total de la factura antes de tributos <value-of select="."/>
 diferente de la suma de los valores de las líneas de la factura que contienen valor comercial: <value-of select="(sum(../..//cac:InvoiceLine/cbc:LineExtensionAmount))"/>
</assert>
<assert flag="fatal" test="if (boolean(/DebitNote)) then . = (sum(../../cac:DebitNoteLine/cbc:LineExtensionAmount)) else true()">[IB02]- (R) Valor bruto total de la factura antes de tributos <value-of select="."/>
 diferente de la suma de los valores de las líneas de la factura que contienen valor comercial: <value-of select="(sum(../..//cac:InvoiceLine/cbc:LineExtensionAmount))"/>
</assert>
</rule>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then . = sum(../../cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount) else true()">[IB03]- (R) Base imponible para el cálculo de los tributos '<value-of select="."/>
' diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : '<value-of select="sum(../../cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)"/>
'
</assert>
<assert flag="fatal" test="if (boolean(/CreditNote)) then . = sum(../../cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount) else true()">[IB03]- (R) Base imponible para el cálculo de los tributos '<value-of select="."/>
' diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : '<value-of select="sum(../../cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)"/>
'
</assert>
<assert flag="fatal" test="if (boolean(/DebitNote)) then . = sum(../../cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount) else true()">[IB03]- (R) Base imponible para el cálculo de los tributos '<value-of select="."/>
' diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : '<value-of select="sum(../../cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)"/>
'
</assert>
</rule>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then round(number(../cbc:LineExtensionAmount + $SumGlobalTaxFE)) = round(number(.)) else true()">[IB04]- (R) Monto Incluyendo Impuesto <value-of select="."/>
 diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : <value-of select="(../cbc:LineExtensionAmount + $SumGlobalTaxFE)"/>
</assert>
<assert flag="fatal" test="if (boolean(/CreditNote)) then round(number(../cbc:LineExtensionAmount + $SumGlobalTaxNC)) = round(number(.)) else true()">[IB04]- (R) Monto Incluyendo Impuesto <value-of select="."/>
 diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : <value-of select="(../cbc:LineExtensionAmount + $SumGlobalTaxFE)"/>
</assert>
<assert flag="fatal" test="if (boolean(/DebitNote)) then round(number(../cbc:LineExtensionAmount + $SumGlobalTaxND)) = round(number(.)) else true()">[IB04]- (R) Monto Incluyendo Impuesto <value-of select="."/>
 diferente del valor bruto total de la factura, sumado a los cargos totales a la facutra, y restado de los descuentos totales a la factura : <value-of select="(../cbc:LineExtensionAmount + $SumGlobalTaxFE)"/>
</assert>
</rule>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then . = $SumTotalAllowanceFE else true()">[IB05]- (R) Total descuentos <value-of select="."/>
 diferente de la suma de todos los descuentos aplicados al total de la factura : <value-of select="$SumTotalAllowanceFE"/>
</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then . = $SumTotalAllowanceNC else true()">[IB05]- (R) Total descuentos <value-of select="."/>
 diferente de la suma de todos los descuentos aplicados al total de la factura : <value-of select="$SumTotalAllowanceNC"/>
</assert>
<assert flag="fatal" test="if (boolean(/Invoice)) then . = $SumTotalAllowanceND else true()">[IB05]- (R) Total descuentos <value-of select="."/>
 diferente de la suma de todos los descuentos aplicados al total de la factura : <value-of select="$SumTotalAllowanceND"/>
</assert>
</rule>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then . = $SumTotalChargeFE else true()">[IB06]- (R) Total cargos <value-of select="."/>
 diferente de la suma de todos los cargos aplicados al total de la factura : <value-of select="$SumTotalChargeFE"/>
</assert>
<assert flag="fatal" test="if (boolean(/CreditNote)) then . = $SumTotalChargeNC else true()">[IB06]- (R) Total cargos <value-of select="."/>
 diferente de la suma de todos los cargos aplicados al total de la factura : <value-of select="$SumTotalChargeNC"/>
</assert>
<assert flag="fatal" test="if (boolean(/DebitNote)) then . = $SumTotalChargeND else true()">[IB06]- (R) Total cargos <value-of select="."/>
 diferente de la suma de todos los cargos aplicados al total de la factura : <value-of select="$SumTotalChargeND"/>
</assert>
</rule>
...
<assert flag="fatal" test="if (boolean(/Invoice)) then . = $PayableAmountFE else true()">[IB09]- (R) Total de la factura <value-of select="."/>
 diferente de la suma de Total valor bruto + Total Tributos - Total Tributo Retenidos - Anticipos (+/-) Redondeos : <value-of select="$PayableAmountFE"/>
</assert>
<assert flag="fatal" test="if (boolean(/CreditNote)) then . = $PayableAmountNC else true()">[IB09]- (R) Total de la factura <value-of select="."/>
 diferente de la suma de Total valor bruto + Total Tributos - Total Tributo Retenidos - Anticipos (+/-) Redondeos : <value-of select="$PayableAmountNC"/>
</assert>
<assert flag="fatal" test="if (boolean(/DebitNote)) then . = $PayableAmountND else true()">[IB09]- (R) Total de la factura <value-of select="."/>
 diferente de la suma de Total valor bruto + Total Tributos - Total Tributo Retenidos - Anticipos (+/-) Redondeos : <value-of select="$PayableAmountND"/>
</assert>
</rule>
...
<assert flag="warning" test="number(cbc:MultiplierFactorNumeric) &lt;= 100">[JA07] (R) -Notificación: si cbc:MultiplierFactorNumeric : '<value-of select="./cbc:MultiplierFactorNumeric"/>
' > 100 </assert>
</rule>
...
<let name="k" value="$j mod 11"/>
<let name="dv" value="if ($k &gt;= 2) then 11 - $k else $k"/>
<assert flag="fatal" test="if(@schemeName = '31') then $dv = ./@schemeID else true()">[HD04b]-DV del NIT Mandante : '<value-of select="@schemeID"/>
' no está correctamente calculado : '<value-of select="$dv"/>
'</assert>
